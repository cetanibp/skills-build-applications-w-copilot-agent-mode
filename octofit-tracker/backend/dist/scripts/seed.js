...
async function seedDatabase() {
    try {
        ...
        const summary = {
            users: await models_1.User.countDocuments(),
            teams: await models_1.Team.countDocuments(),
            activities: await models_1.Activity.countDocuments(),
            leaderboard: await models_1.LeaderboardEntry.countDocuments(),
            workouts: await models_1.Workout.countDocuments(),
        };
